...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/departments/emergency', i18nKey: 'nav.emergency', icon: Siren, roles: ['EMERGENCY_STAFF', 'ADMIN', 'NURSE', 'DOCTOR'] },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/emergency/beds', i18nKey: 'nav.emergencyBeds', icon: BedDouble, roles: ['ADMIN', 'EMERGENCY_STAFF'] },
